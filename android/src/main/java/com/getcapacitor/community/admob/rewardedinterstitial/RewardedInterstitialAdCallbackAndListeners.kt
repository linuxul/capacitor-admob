...
public object RewardedInterstitialAdCallbackAndListeners {

    public fun getOnUserEarnedRewardListener(
        call: PluginCall,
        notifyListenersFunction: BiConsumer<String, JSObject>
    ): OnUserEarnedRewardListener = OnUserEarnedRewardListener { item: RewardItem ->
    ...
    public fun getRewardedAdLoadCallback(
        call: PluginCall,
        notifyListenersFunction: BiConsumer<String, JSObject>,
        adOptions: AdOptions
    ): RewardedInterstitialAdLoadCallback = object : RewardedInterstitialAdLoadCallback() {
